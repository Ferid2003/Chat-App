            ...
            <div className="login-container">
                <div className="login-cont-holder">
                    ...
                    <form className="login-form">
                        <input onChange={handleChange} name="username" type="text" className="email" placeholder="Email"/>
                        ...
                        <button disabled={loading} onClick={register} className="login">Register</button>
